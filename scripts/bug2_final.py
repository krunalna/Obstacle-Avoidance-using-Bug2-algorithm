...
def bug2():
    ...
    #     global line_follow_flag, wall_follow_flag
    ...
    #     B=x2-x1
    #     C=x1*y2-y1*x2
    #     obstacle_check = obstacle_detection()

    #     #print(obstacle_check)
    ...
    while not rospy.is_shutdown():
        ...
        if(state == "WALL_FOLLOW"):
            while True:
                ...
                if(get_distance()<0.3 and line_follow_flag==True):
                    while True:
                        wallfollow()
